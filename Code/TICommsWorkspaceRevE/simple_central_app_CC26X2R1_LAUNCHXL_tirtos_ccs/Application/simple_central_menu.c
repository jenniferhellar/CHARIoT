...
//Macro to check if we can connect to more then 8 connection
//to enable the two bottun menue for multiple connections
#define MULTI_CONNECT(X)  ((X) > (8) ? TRUE : FALSE)
...
MENU_OBJ(scMenuMain, "Simple Central", 7, NULL)
  ...
  MENU_ITEM_SUBMENU(&scMenuAutoConnect)
MENU_OBJ_END
...
MENU_OBJ(scMenuAutoConnect, "Set AutoConnect", 3, &scMenuMain)
  MENU_ITEM_ACTION("Disable", SimpleCentral_doAutoConnect)
  MENU_ITEM_ACTION("Group A", SimpleCentral_doAutoConnect)
  MENU_ITEM_ACTION("Group B", SimpleCentral_doAutoConnect)
MENU_OBJ_END
...
MENU_OBJ(scMenuSelectConn, "Work with", MAX_NUM_BLE_CONNS, &scMenuMain)
  ...
  MENU_ITEM_ACTION(NULL, SimpleCentral_doSelectConn)
  MENU_ITEM_ACTION(NULL, SimpleCentral_doSelectConn)
#if MULTI_CONNECT(MAX_NUM_BLE_CONNS)
  MENU_ITEM_ACTION(NULL, SimpleCentral_doSelectConn)
  MENU_ITEM_ACTION(NULL, SimpleCentral_doSelectConn)
  MENU_ITEM_ACTION(NULL, SimpleCentral_doSelectConn)
  MENU_ITEM_ACTION(NULL, SimpleCentral_doSelectConn)
